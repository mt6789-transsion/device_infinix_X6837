...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/lib64/libspeech_enh_lib.so', 'vendor/lib64/libalsautils-v31.so', 'vendor/lib64/libwifi-hal-mtk.so', 'vendor/lib64/libnir_neon_driver_ndk.mtk.vndk.so'): blob_fixup()
        .fix_soname(),
